										...
										<div class="modal-content">
											<div class="modal-header">
												...
												<div class="modal-footer">
													...
													<a href="<?php echo base_url()."web_sekolah/hapus_data/".$perusahaan->id_per."/".$perusahaan->logo_per; ?>/perusahaan"><button type="button" class="btn btn-outline">Yakin</button>
													</a>
												</div>
											</div>
											<!-- /.modal-content -->
